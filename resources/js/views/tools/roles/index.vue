...
<script>
    import AddRole from "@/components/Tools/Roles/AddRole";
    import EditRole from "@/components/Tools/Roles/EditRole";
    ...
    export default {
        ...
        methods: {
            get_roles_list: function () {
                let _this = this;
                this.$get(this.$tools.getRolesList).then((res) => {
            ...
            delrole(id) {
                var _this = this;
                this.$delete(this.$tools.delRoles + id).then((res) => {
                    if (res.code === 200) {
