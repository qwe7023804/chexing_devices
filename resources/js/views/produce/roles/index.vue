...
<script>
    import AddRole from "@/components/Produce/Roles/AddRole";
    import EditRole from "@/components/Produce/Roles/EditRole";
    ...
    export default {
        ...
        methods: {
            get_roles_list: function () {
                let _this = this;
                this.$get(this.$produce.getRolesList).then((res) => {
            ...
            delrole(id) {
                var _this = this;
                this.$delete(this.$produce.delIdentity + id).then((res) => {
                    if (res.code === 200) {
