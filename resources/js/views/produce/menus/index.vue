...
<script>
    import AddMenu from "@/components/Produce/Menus/AddMenu";
    import DirectorySort from "@/components/Produce/Menus/DirectorySort";
    import EditMenu from "@/components/Produce/Menus/EditMenu";
    ...
    export default {
        ...
        methods: {
            get_menus_list() {
                let _this = this;
                this.$get(this.$produce.getMenusList).then((res) => {
            ...
            directoryDelete(id) {
                var _this = this;
                this.$delete(this.$produce.delMenus + id).then((res) => {
                    if (res.code === 200){
