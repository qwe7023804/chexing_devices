...
<script>
    import AddUser from "@/components/Produce/Users/AddUser";
    import EditUserinfo from "@/components/Produce/Users/EditUserinfo";
    import ChangePassword from "@/components/Produce/Users/ChangePassword";
    import ChangeRoles from "@/components/Produce/Users/ChangeRoles";
    ...
    export default {
        ...
        methods: {
            get_users_list() {
                let _this = this;
                this.$get(this.$produce.getUsersList).then((res) => {
            ...
            deluser(userinfo) {
                var vm = this;
                this.$delete(this.$produce.delUsers + userinfo.id).then((res) => {
                    if (res.code === 200) {
