...
use App\Models\Produce\Menu;
use App\Models\Produce\Role;
use App\Models\Produce\RoleToUser;
...
class UserController extends BaseController
{
    ...
    public function edit_user_role(Request $request, $user_id)
    {
        ...
        $role_user = RoleToUser::select('role_id')->where('user_id', $user_id)->get();
        if ($role_user->count()) {
            $role_id = [];
